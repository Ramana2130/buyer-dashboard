...
router.post("/seller" , async (req, res) => {
    try {
        const {fullName, email, password, phoneNumber, address, coordinates} = req.body;
        ...
        const newUser = new SellerModels({fullName, email, password, phoneNumber, address, coordinates})
            await newUser.save();
